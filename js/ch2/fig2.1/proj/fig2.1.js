...
// get data. We'll use the project version for now?
  d3.json('https://gist.githubusercontent.com/mheydt/29eec003a4c0af362d7a/raw/d27d143bd75626647108fc514d8697e0814bf74b/us-states.json')
    .then(function(mapUSA) {
        ...
        // get our data in there. Let's put it on the github repo to make it more 
        // accessible

        let pointData = d3.csv("https://raw.githubusercontent.com/danchurch/bayesSpatioTemp/main/js/ch2/fig2.1/Tmax_1.csv")

        // here we would put in our scatter plot with the lat/long coordinates instead of console.log
        pointData.then(function(data){console.log(data)})
